...
func (s *Server) setupRoutes() {
	...
	v1.Post("/namespaces", handlers.CreateNamespace(s.db, s.audit))
	v1.Get("/namespaces/:namespace", handlers.GetNamespace(s.db))
	v1.Head("/namespaces/:namespace", handlers.NamespaceExists(s.db))
	v1.Delete("/namespaces/:namespace", handlers.DeleteNamespace(s.db, s.audit))
	...
	v1.Post("/namespaces/:namespace/tables", handlers.CreateTable(s.db, s.config, s.audit))
	...
	v1.Delete("/namespaces/:namespace/tables/:table", handlers.DropTable(s.db, s.audit))
	...
	v1.Post("/namespaces/:namespace/views", handlers.CreateView(s.db, s.config, s.audit))
	...
	v1.Delete("/namespaces/:namespace/views/:view", handlers.DropView(s.db, s.audit))
	...
	prefix.Post("/namespaces", handlers.CreateNamespace(s.db, s.audit))
	prefix.Get("/namespaces/:namespace", handlers.GetNamespace(s.db))
	prefix.Head("/namespaces/:namespace", handlers.NamespaceExists(s.db))
	prefix.Delete("/namespaces/:namespace", handlers.DeleteNamespace(s.db, s.audit))
	...
	prefix.Post("/namespaces/:namespace/tables", handlers.CreateTable(s.db, s.config, s.audit))
	...
	prefix.Delete("/namespaces/:namespace/tables/:table", handlers.DropTable(s.db, s.audit))
	...
	prefix.Delete("/namespaces/:namespace/views/:view", handlers.DropView(s.db, s.audit))
